                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__right__auth">
                            <a id="modal_trigger" href="#modal"><i class="fa fa-user"></i> Login</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="./index.html"><img src="{{ asset($config->logo) }}" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
...
<!-- Hero Section Begin -->
<section class="hero {{ !empty($title) ? 'hero-normal' : '' }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                ...
                @if (empty($title))
                <div id="slider">
                    <div class="hero__item set-bg" data-setbg="{{ asset('asset/custommer') }}/img/hero/banner.jpg">
